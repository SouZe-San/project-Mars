...
const HeroSection = ({
  scrollDivContainerRef,
}: {
  scrollDivContainerRef: React.RefObject<HTMLDivElement>;
}) => {
  return (
    <div id="heroSection">
      {/* Background Circles */}
      ...
      {/* 3d Marse  */}
      <div className="middle_section relative mt-16">
        <div className="model-wrapper absolute" ref={scrollDivContainerRef}>
          <svg
